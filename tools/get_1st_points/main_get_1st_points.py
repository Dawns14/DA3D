...
class Get1stPoints():
    ...
    def get_1st_points_from_lpc_for_4drt(self, dict_item):
        ...
        rae_list = np.concatenate((r, az, el), axis=1)
        ...
        rae_tensor = np.full((n_r, n_a, n_e), False, dtype=bool)
        ...
        rdr_ind_a = (n_a-a_indices-1)+1
        rdr_ind_e = (n_e-e_indices-1)+1
    ...
    def get_points_from_quantized_indices(self, dict_item):
        ...
        rdr_ind_e = quantized_indices[:,2]-1
...
if __name__ == '__main__':
    ...
    print('* Total samples: ', len(get_1st_points))
