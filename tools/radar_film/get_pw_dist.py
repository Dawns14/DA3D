...
class RadarFilmDataProcessor(object):
    ...
    def gen_label_for_single_object(self, first_minimum_range=10., minimum_iou=0.01):
        ...
        for idx_dict, dict_item in enumerate(tqdm(self.list_dict_item)):
            seq_name = dict_item['meta']['seq']
            if seq_name not in list_checking_duplication:
...
class ModelLoader(object):
    ...
    def infer_ldr_model(self, pc_lidar):
        ...
        dict_input = dict()
        list_pc_lidar = torch.from_numpy(pc_lidar_input).float()
        dict_input['ldr64'] = list_pc_lidar
        batch_indices = torch.full((len(pc_lidar_input),), 0)
...
dict_cfg = dict(
    ...
    seq_info = {
        '1': 'baseline1',
        '2': 'baseline2',
        '10': '4mm-rect/0.1T/Open',
        '12': '4mm-rect/0.1T/3V-200mA',
        '14': '8mm-rect/0.1T/Open',
        '16': '8mm-rect/0.1T/3V-30mA',
        '30': '2mm-rect/0.3T/Open',
        '31': '2mm-rect/0.3T/Open',
        '32': '9_on_2V_460mA',
        '33': '2mm-rect/0.3T/2V-460mA',
        '34': '4mm-rect/0.3T/Open',
        '35': '10_off',
        '36': '10_on_2V_217mA',
        '37': '4mm-rect/0.3T/2V-217mA',
        '40': '0.5mm-rect/0.125T/Open',
        '42': '11-2_off',
        '44': '0.8mm-round/0.5T/Open 1',
        '46': '0.8mm-round/0.5T/Open 2',
        '48': 'Without film 1',
        '49': 'Without film 2',
    },
