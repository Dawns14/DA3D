...
class CFAR:
    def __init__(self, type='pointcloud', cfg=None):
        ...
        self.grid_size = self.cfg.DATASET.RDR_CUBE.GRID_SIZE
        ...
        self.fa_rate = self.cfg.DATASET.RDR_CUBE.CFAR_PARAMS.FA_RATE
        self.thr_rate = self.cfg.DATASET.RDR_CUBE.CFAR_PARAMS.THR_RATE
    ...
    def ca_cfar(self, cube, cube_doppler):
        ...
        mask_size = (2*(nh_g_z+nh_t_z)+1, 2*(nh_g_y+nh_t_y)+1, 2*(nh_g_x+nh_t_x)+1)
