...
class KRadarTracking_v1_0(Dataset):
    def __init__(self, cfg=None, split='all'):
        ...
        self.collate_ver = self.cfg.get('collate_fn', 'v2_0')
    ...
    def load_dict_item(self, path_data, split):
        ...
        for seq, path_header in list_seqs_w_header:
            ...
            if seq not in list_check_duplicated_seq:
                now_split = 'train'
        ...
        for idx_seq in range(58):
            ...
            part_0 = list_dict_item[idx_0:idx_1]
            part_1 = list_dict_item[idx_1:idx_2]
            part_2 = list_dict_item[idx_2:idx_3]
            part_3 = list_dict_item[idx_3:idx_4]
