...
class KRadarDetection_v2_1(Dataset):
    ...
    def save_proportional_rdr_pc(self, dict_save=None, root_path='/media/donghee/A4'):
...
if __name__ == '__main__':
    ...
    print(dict_item['camera_intrinsics'])
    print(dict_item['camera2lidar'])
    print(dict_item['lidar2image'])
