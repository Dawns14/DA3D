...
class MainFrame(QMainWindow, class_ui):
    ...
    def init_signals(self):
        list_name_fuction = [
            ...
            'pushButtonLidarVis',
            'pushButtonRadarVis',
            'pushButtonLoadSubset',
            'pushButtonLoadConfig',
            'pushButtonLoadModel',
            'pushButtonInference',
            'pushButtonInfCamera',
            'pushButtonInfLidar',
    ...
    def pushButtonLoad(self):
        ...
        for idx_label, path_label in tqdm(enumerate(label_paths)):
    ...
    def pushButtonInfRadar(self):
        ...
        self.kradar.show_radar_tensor_bev(self.dict_datum, bboxes,\
            roi_x = [0, 0.4, 80], roi_y = [-60, 0.4, 60], alpha = alpha, lthick = lthick,\
            infer = self.pred_objects, infer_gt = self.gt_objects, norm_img = rdr_vis_norm)
