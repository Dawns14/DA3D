...
class LidarSparseBackbone(nn.Module):
    def __init__(self, cfg):
        super(LidarSparseBackbone, self).__init__()
        self.cfg = cfg
    ...
    def forward(self, dict_item):
        sparse_features, sparse_indices = dict_item['lidar_voxel_features'], dict_item['lidar_voxel_coords']
